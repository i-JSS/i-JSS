import { Github, Linkedin, Mail, Moon, Sun, MapPin } from "lucide-react";
...
export default function Footer({ tr, theme, toggleTheme }: FooterProps) {
  return (
    <footer className="relative bg-[#0d0d0d] border-t border-white/[0.06] pt-16 pb-10 px-6 lg:px-12 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid md:grid-cols-2 gap-12 mb-14">
          {/* Identity */}
          <div>
            <div className="font-black text-2xl tracking-tight text-white mb-3 font-mono">JG</div>
