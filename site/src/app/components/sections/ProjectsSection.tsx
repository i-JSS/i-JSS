...
import {
  ...
  slideLeftChild, slideLeftChildReduced,
  staggerParent,
  pick,
} from "@/lib/animate";
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
          <span className="text-[10px] uppercase tracking-[0.15em] font-mono px-3 py-1 rounded-full bg-black/50 text-white backdrop-blur-md">
            {categoryLabel}
          </span>
          {project.repository && (
            <a
