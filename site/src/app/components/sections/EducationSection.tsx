...
import {
  ...
  fadeUpChild, fadeUpChildReduced,
  staggerParent,
  pick,
} from "@/lib/animate";
            ...
            <div>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className="inline-block rounded-lg border border-primary/30 bg-primary/10 px-3 py-1.5 text-xs font-mono font-semibold text-primary shrink-0">
                    Advanced 1
                  </span>
                </div>
              </EducationCard>
